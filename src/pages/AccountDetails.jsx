...
const AccountDetails = () => {
  ...
  const [fdData, setFdData] = useState({ amount: '', duration: '6' });
    ...
    <div>
      ...
      <div className="glass-panel" style={{ padding: '2.5rem', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', marginTop: '2.5rem', flexWrap: 'wrap' }}>
          ...
          <button className="btn btn-secondary" onClick={() => { setActionType('withdraw'); setFdCreating(false); }}>Withdraw</button>
          ...
          <button className="btn btn-danger" style={{ marginLeft: 'auto' }} onClick={handleDelete}>Delete Account</button>
        </div>
      </div>
              ...
              <div className="input-group" style={{ marginBottom: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem', alignItems: 'center' }}>
                  ...
                  <span style={{ color: 'var(--primary-color)', fontWeight: 'bold', background: 'rgba(212, 175, 55, 0.1)', padding: '0.2rem 0.6rem', fontSize: '0.85rem' }}>
                    {getInterestRate(fdData.duration)}% p.a. Interest
                  </span>
                </div>
                <input 
                  type="range" 
